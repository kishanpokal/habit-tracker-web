...
export default function AnalyticsPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "linear-gradient(to bottom right, #111827, #1f2937, #111827)" }}>
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-16 w-16 border-4 border-blue-500 border-t-transparent mb-4" style={{ borderColor: "rgba(59, 130, 246, 0.3)", borderTopColor: "#3b82f6" }}></div>
  ...
  if (habits.length === 0) {
    return (
      <>
        <TopNav />
        <main className="min-h-screen pt-40 px-4 pb-12" style={{ background: "linear-gradient(to bottom right, #111827, #1f2937, #111827)" }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center py-20 rounded-2xl shadow-2xl border" style={{ backgroundColor: "rgba(31, 41, 55, 0.5)", backdropFilter: "blur(12px)", borderColor: "#374151" }}>
              <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: "rgba(59, 130, 246, 0.1)" }}>
                <Activity className="w-12 h-12 text-blue-400" />
              </div>
              <h2 className="text-2xl font-bold text-gray-100 mb-3">No Habits to Analyze</h2>
              <p className="text-gray-400 mb-8 max-w-md mx-auto">
                Start creating habits to unlock powerful insights and track your progress over time.
              </p>
              <button className="px-6 py-3 text-white rounded-lg font-medium transition-all shadow-lg" style={{ background: "linear-gradient(to right, #3b82f6, #9333ea)" }}>
  ...
  return (
    <>
      <TopNav />
      <main className="min-h-screen pt-40 px-4 pb-20" style={{ background: "linear-gradient(to bottom right, #111827, #1f2937, #111827)" }}>
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <header className="space-y-3">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2 rounded-lg shadow-lg border p-1" style={{ backgroundColor: "rgba(31, 41, 55, 0.8)", backdropFilter: "blur(12px)", borderColor: "#374151", zIndex: 10 }}>
                <button
                  onClick={() => {
            ...
            >
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={performanceData}>
                  ...
                  <XAxis 
                    dataKey="name" 
                    tick={{ fill: "#9ca3af", fontSize: timeRange === "7d" ? 12 : 10 }} 
          ...
          >
            <ResponsiveContainer width="100%" height={320}>
              <AreaChart data={monthlyData}>
                ...
                <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                <XAxis dataKey="date" tick={{ fill: "#9ca3af", fontSize: 11 }} interval={timeRange === "7d" ? 0 : 4} />
                <YAxis allowDecimals={false} tick={{ fill: "#9ca3af", fontSize: 12 }} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: "#1f2937",
          ...
          >
            <ResponsiveContainer width="100%" height={380}>
              <LineChart data={habitsOverTimeData}>
                <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                <XAxis dataKey="date" tick={{ fill: "#9ca3af", fontSize: 11 }} interval={timeRange === "7d" ? 0 : 4} />
                <YAxis domain={[0, 1]} ticks={[0, 1]} tick={{ fill: "#9ca3af", fontSize: 12 }} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: "#1f2937",
                    border: "1px solid #374151",
            ...
            >
              <ResponsiveContainer width="100%" height={340}>
                <RadarChart data={radarData}>
                  ...
                  <PolarAngleAxis dataKey="habit" tick={{ fill: "#9ca3af", fontSize: 11 }} />
            ...
            >
              <ResponsiveContainer width="100%" height={340}>
                <BarChart data={dayOfWeekData} layout="vertical">
                  ...
                  <YAxis dataKey="day" type="category" tick={{ fill: "#9ca3af", fontSize: 12 }} />
                  <Tooltip
                    contentStyle={{
                      backgroundColor: "#1f2937",
                      border: "1px solid #374151",
          ...
          {/* Detailed Breakdown */}
          <div className="rounded-2xl shadow-2xl border overflow-hidden" style={{ backgroundColor: "rgba(31, 41, 55, 0.5)", backdropFilter: "blur(12px)", borderColor: "#374151" }}>
            <div className="p-6 border-b" style={{ background: "linear-gradient(to right, rgba(30, 58, 138, 0.5), rgba(88, 28, 135, 0.5))", borderColor: "#374151" }}>
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold text-gray-100">Detailed Habit Breakdown</h2>
                    ...
                    habitBreakdown.map((habit, idx) => (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div
                            className="w-3 h-3 rounded-full mr-3 ring-2"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold text-green-400 border" style={{ background: "linear-gradient(to right, rgba(16, 185, 129, 0.2), rgba(5, 150, 105, 0.2))", borderColor: "rgba(16, 185, 129, 0.3)" }}>
                          {habit.percent}%
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm font-semibold text-gray-200">{habit.streak} days</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
...
function StatCard({
  ...
  return (
    <div className="rounded-2xl shadow-xl border p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group" style={{ backgroundColor: "rgba(31, 41, 55, 0.5)", backdropFilter: "blur(12px)", borderColor: "#374151" }}>
      <div className="flex items-start justify-between mb-4">
        <div className="p-3 rounded-xl text-white shadow-lg" style={{ background: colorGradients[color as keyof typeof colorGradients] }}>
          {icon}
        </div>
        {trend && (
          <span className="text-xs text-green-400 font-semibold flex items-center gap-1 px-2 py-1 rounded-lg border" style={{ backgroundColor: "rgba(16, 185, 129, 0.1)", borderColor: "rgba(16, 185, 129, 0.2)" }}>
      ...
      <div>
        ...
        <div className="flex items-baseline gap-2">
          <p className="text-3xl font-extrabold text-gray-100 group-hover:text-blue-400 transition-colors">
            {value}
          </p>
...
function ChartCard({
  ...
  return (
    <div
      id={id}
      className="rounded-2xl shadow-xl border p-6 hover:shadow-2xl transition-all duration-300"
      style={{ backgroundColor: "rgba(31, 41, 55, 0.5)", backdropFilter: "blur(12px)", borderColor: "#374151" }}
    >
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 text-white rounded-lg shadow-lg" style={{ background: "linear-gradient(to bottom right, #3b82f6, #9333ea)" }}>
            {icon}
          </div>
        ...
        <button
          onClick={onExport}
          className="group flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-gray-300 rounded-xl transition-all duration-300 border shadow-sm hover:shadow-lg"
