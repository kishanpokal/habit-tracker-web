      ...
      <div className="w-full max-w-lg rounded-3xl bg-white dark:bg-[#121218] shadow-2xl border border-stone-200 dark:border-[#272732] overflow-hidden my-auto flex flex-col max-h-[92vh]">
        ...
        {successAnimation && (
          <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-[#121218] rounded-3xl p-8 border border-[#272732] shadow-2xl text-center max-w-xs w-full">
              ...
              <h3 className="text-lg font-black font-heading text-white mb-1">Habit Initialized!</h3>
              <p className="text-xs text-[#9090A0]">Ready to build your new streak ✨</p>
            </div>
          </div>
        )}
        ...
        <div className="bg-gradient-to-r from-[#7C3AED] via-[#6D28D9] to-[#EAB308] p-5 sm:p-6 text-white flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-black font-heading">New Habit Routine</h2>
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-4 flex-1">
          <div>
            ...
            <input
              type="text"
              placeholder="e.g. 20-minute Workout, Read 15 Pages, Code..."
              value={name}
              onChange={(e) => setName(e.target.value)}
              className="w-full rounded-xl border border-stone-200 dark:border-[#272732] bg-slate-50 dark:bg-[#1A1A22] px-3.5 py-2.5 text-xs sm:text-sm text-slate-900 dark:text-white outline-none focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20"
            />
          </div>
